...
<body>
    <div class="login-form" id="main">
         <div  style="margin-left:0px; width:100px;">
           ...
           <div  style="margin-left:380px; width:100px">
    ...
    <img class="irc_mi" src="https://i1.imgiz.com/rshots/7994/ali-babanin-bir-ciftligi-var-sarkisi_7994254-1870_1280x720.jpg" width="300" height="200" style="margin-left:70px;">
           ...
           <h1>Ali BaBa's Farm</h1>
                     <br>       
              <div>
                    <div style="margin-left:120px; margin-right:30px; width:210px;" class="input-group">
                  ...
                  <div style="margin-left:120px; margin-right:30px; width:250px;" class="input-group">
                      <span class="input-group-btn">
            ...
            <div  style="margin-left:130px; width:150px;" class="form-group">
                    <button name="submit" type="submit" value=" Login " class="log-btn">Submit Order</button>
